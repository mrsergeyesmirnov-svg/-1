...
RECOMMENDATIONS: dict[str, str] = {
    "kitchen": "Разберите отдачу с шефом: где срывается тайминг на пике.",
    "team": "Посмотрите расстановку и атмосферу в команде — без публичного разбора людей.",
    "staff": "Сверьте график и зоны: где нехватка закрывается чужими руками.",
    "processes": "Пройдите открытие/закрытие и зоны ответственности до пика.",
    "management": "Пройдите открытие/закрытие и зоны ответственности до пика.",
    "self": "Тет-а-тет с теми, кто тянет смены: как они себя чувствуют, что поможет.",
    "conflict": "Разберите конфликтные точки зал ↔ кухня / бар без публичного разбора людей.",
    "stress": "Проверьте плотность смен и переработки — команда сигналит о перегрузе.",
    "guests": "Разберите сервис на пике: где гости создают напряжение линии.",
    "rating_drop": "Разберите последние смены на планёрке: что повторяется в голосе линии.",
    "improved": "Зафиксируйте, что сработало — команда видит эффект от решения.",
}
