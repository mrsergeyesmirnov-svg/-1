...
- **Академия** = дом / витрина. Не методичка. Задача — прижать к продукту.
- **«Состояние смены»** (`sostoyanie-smeny/`) = там 8 этапов, 4 блока, цикл, диагностика.
- Туры и база — соседние двери, слабее главного входа.
- Pulse / CRM / аудит не в публичном меню академии.
