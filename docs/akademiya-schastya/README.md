...
Внутренний контур (не витрина): `platform/` — CRM, калькулятор, финансы, план туров.  
Вход: тихая ссылка в футере «Платформа для консультантов». Пароль `smena2026`.

Подробности: `platform/README.md`.
...
Платформа: http://127.0.0.1:8767/akademiya-schastya/platform/
