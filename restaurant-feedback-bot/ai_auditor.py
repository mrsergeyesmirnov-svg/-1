...
Расшифровка может быть на русском, узбекском, таджикском, казахском или смеси —
понимай смысл по содержанию, не требуй идеальный русский. Если речи мало или
распознавание обрывками — честно снижай уверенность в summary, не выдумывай факты
и не ставь всем блокам одинаковые «круглые» 50 без оснований в тексте.
    ...
    *,
    ...
    for i, ch in enumerate(chunks, start=1):
        ...
        text = await ai_advisor.transcribe_voice(
            raw, filename=filename, language=None
        )
        if not text:
