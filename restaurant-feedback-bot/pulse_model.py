...
def manager_menu_shift_markup():
    ...
    return ReplyKeyboardMarkup(
        keyboard=[
            ...
            [
                KeyboardButton(text=BTN_STOP_LIST),
                KeyboardButton(text=BTN_STOP_ADD),
            ],
            [
...
def admin_commands_reference_chunks() -> list[str]:
    ...
    return [
        ...
        (
            ...
            f"{BTN_STOP_LIST}, {BTN_STOP_ADD}, {BTN_STOP_CURRENT}, {BTN_RATE_SHIFT}, "
            f"{BTN_OPS_BROADCAST}, {BTN_CHECKLISTS}, {BTN_MONTH_PLAN}, {BTN_STAFF_OUT}, {BTN_TASKS}\n"
            ...
            f"{BTN_STOP_LIST} — заменить стоп-лист целиком\n"
            f"{BTN_STOP_ADD} — добавить к текущему стоп-листу\n"
